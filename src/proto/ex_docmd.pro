...
int do_cmdline(char_u *cmdline, getline_func_T fgetline, void *cookie, int flags);
int getline_equal(getline_func_T fgetline, void *cookie, getline_func_T func);
void *getline_cookie(getline_func_T fgetline, void *cookie);
